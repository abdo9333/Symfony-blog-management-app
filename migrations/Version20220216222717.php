 ...
 */
final class Version20220216222717 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post CHANGE updated_at updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', CHANGE image_name imagename VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post ADD image_name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP imagename, CHANGE updated_at updated_at DATETIME NOT NULL, CHANGE title title VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE discription discription LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`');
