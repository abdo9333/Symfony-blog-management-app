 ...
 */
final class Version20220224180738 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment CHANGE ceated_at ceated_at DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment CHANGE auther auther VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE ceated_at ceated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', CHANGE content content LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`');
